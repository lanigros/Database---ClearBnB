...
@NamedQueries({@NamedQuery(name = "HomeHistoryLog.findByHomeId", query = "SELECT h from HomeHistoryLog h " + "WHERE home_id = :id")})
public class HomeHistoryLog {
    ...
    public String toString() {
        return "HomeHistoryLog{" + "id=" + id + ", home=" + home + ", pricePerNight=" + pricePerNight + ", startDate=" + startDate + ", endDate=" + endDate + ", createdDate=" + createdDate + '}';
    }
