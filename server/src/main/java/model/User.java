...
@Entity
@Table(name = "user")
@NamedQueries({@NamedQuery(name = "User.findById", query = "SELECT u FROM User WHERE u.id = :id"),
...
public class User {
  ...
  public String toString() {
    return "User{" + "id=" + id + ", firstName='" + firstName + '\'' + ", lastName='" + lastName
        + '\'' + ", email='" + email + '\'' + ", password='" + password + '\'' + ", hostProfile="
        + hostProfile + ", renterProfile=" + renterProfile + '}';
  }
