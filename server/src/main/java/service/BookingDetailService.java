...
public class BookingDetailService {
  ...
  public Optional<BookingDetail> createBooking(String sessionId,
      BookingDetailCoreDTO bookingDetailCoreDTO) {
    ...
    int duration = Utility.calculateDuration(bookingDetail.getStartDate(),
